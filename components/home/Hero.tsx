...
export const Hero = () => {
  return (
    <div className="relative bg-gradient-to-br md:bg-gradient-to-r from-blue-900 to-blue-100 text-white py-20 md:py-44">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="text-center max-w-3xl mx-auto">
          ...
          <Card className="bg-white/5 backdrop-blur-sm border-white/10 shadow-lg w-fit px-6 mx-auto">
              <SearchBar />
          </Card>
        </div>
      </div>
